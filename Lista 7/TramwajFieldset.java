...
public class TramwajFieldset extends JPanel
{
	private Tramwaj model;
	...
	{
		protected Tramwaj model;
		protected JTextField entry;

		ChangeListener(Tramwaj model, JTextField entry)
		{
			this.model = model;
			this.entry = entry;
		}
